...
Для целых запускаемых приложений, собранных из этих кусочков, — см.
[`../examples/`](../examples/): десять примеров, от простого к сложному,
у каждого своя ссылка «полный пример» на соответствующей странице выше.
